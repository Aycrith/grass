...
test('wp80 desktop FAQ accordion at 1280x800', async ({ page, browserName }) => {
  ...
  await page.screenshot({
    path: 'visual/test-output/_wp80-desktop-faq-accordion.png',
    clip: { x: 0, y: 0, width: 1280, height: 800 },
    timeout: 60_000,
  });

  console.log(`WP80_DESKTOP_FAQ captured`);
});
