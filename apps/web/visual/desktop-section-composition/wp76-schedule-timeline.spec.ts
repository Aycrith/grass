...
test('wp76 desktop schedule timeline at 1280x800', async ({ page, browserName }) => {
  ...
  await page.screenshot({
    path: 'visual/test-output/_wp76-desktop-schedule-timeline.png',
    clip: { x: 0, y: 0, width: 1280, height: 800 },
    timeout: 60_000,
  });

  console.log(`WP76_DESKTOP_SCHEDULE captured`);
});
