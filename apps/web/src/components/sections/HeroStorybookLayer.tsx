...
function BirdbathLayer(): ReactNode {
  return (
    ...
    >
       ...
       * (1230, 645).
       *
       * Position history (the visual-coherence lesson is in
       * memory/MEMORY.md and ledger entry 46):
       *   2026-07-23 v1: (1240, 645) — original position. Sat
       *     right of the right-side ranch house (viewBox x=1400,
       *     scale 0.8). Read as a "satellite sprite" rather than
       *     a focal point.
       *   2026-07-23 v2: (1000, 645) — per the 5-plane open
       *     questions. Moved 240 viewBox units LEFT. Visual
       *     review caught an overlap with the centered subhead
       *     text "Free quotes within 24" in the second line.
       *   2026-07-24 v3: (1100, 645) — first fix attempt.
       *     Moved 100 viewBox units RIGHT from v2. Visual
       *     review STILL showed overlap — the birdbath's bowl
       *     (88 viewBox units wide) was eating "and the" at
       *     the end of the first subhead line. The text block
       *     is wider than I assumed (~430 viewBox units centered
       *     on the storybook column, not ~360).
       *   2026-07-24 v4: (1230, 645) — this version. Moved 130
       *     viewBox units RIGHT from v3. The birdbath is now
       *     clearly RIGHT of the text right edge (~viewBox x=1100)
       *     with ~85 viewBox units of bowl clearance. Still LEFT
       *     of the right ranch house (viewBox x=1400) with ~125
       *     viewBox units of clearance to the ranch house left
       *     edge (~viewBox x=1355 at scale 0.8). This is the
       *     narrowest sweet spot: clear of the text without
       *     re-introducing the v1 satellite issue. */}
