...
test('wp81 desktop editorialbreak full-bleed photo at 1280x800', async ({ page, browserName }) => {
  ...
  await page.screenshot({
    path: 'visual/test-output/_wp81-desktop-editorial-break.png',
    clip: { x: 0, y: 0, width: 1280, height: 800 },
    timeout: 60_000,
  });

  console.log(`WP81_DESKTOP_EDITORIAL captured`);
});
